var resources = function(page, meta) {
	...
	return {
		js : ['common/form-manager.js','common/form-plugins/common-plugins.js','common/form-plugins/options-text-plugin.js','common/form-plugins/tag-plugin.js','common/form-plugins/unbound-table-plugin.js','logic/asset/edit-asset.js','logic/asset.tag.edit.js', 'service.edit.js'], //['edit.asset.js', '/logic/asset.tag.edit.js', 'bootstrap-select.min.js','options.text.js'],
