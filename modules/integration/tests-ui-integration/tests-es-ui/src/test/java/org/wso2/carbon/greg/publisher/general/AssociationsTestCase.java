...
/***
 * This class have test methods for Associations in publisher
 */
public class AssociationsTestCase extends GREGIntegrationUIBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        asset.createGenericTypeAsset(uniqueName, "/" + uniqueName, "1.2.2", "TestDescription1" + uniqueName,
    ...
    @Test(groups = "wso2.greg", description = "Create new version for a created reset service",
            dependsOnMethods = "testClickAndValidate")
    public void testAddAssociation() throws IOException, XPathExpressionException {
        asset.addAssociation(uniqueName, uiElementMapper.getElement("publisher.associations.ownedBy"));
        driver.findElement(By.id(uiElementMapper.getElement("publisher.defaults.overview"))).click();
        driver.findElement(By.linkText(uiElementMapper.getElement("publisher.show.dependency"))).click();
    }
