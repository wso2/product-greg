...
public class WsdlDependencyVerificationTestCase extends GREGIntegrationBaseTest {
    ...
    private final String associatedServicePathBiz = "/_system/governance/trunk/soapservices/com/foo/1.0.0/BizService";
    ...
    private final String associatedServicePathAutomated = "/_system/governance/trunk/soapservices/com/strikeiron/www/1.0.0/DoNotCallRegistry";
    ...
    private final String associatedServicePathAmazon = "/_system/governance/trunk/soapservices/com/amazon/soap/1.0.0/AmazonSearchService";
