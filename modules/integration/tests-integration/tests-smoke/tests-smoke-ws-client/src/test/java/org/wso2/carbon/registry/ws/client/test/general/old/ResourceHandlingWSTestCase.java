 ...
 */
public class ResourceHandlingWSTestCase extends GREGIntegrationBaseTest {
    ...
    public void resourceCopy() throws Exception {
        try {
            ...
            assertEquals(new String((byte[]) r1.getContent()), new String((byte[]) r2.getContent()), "File content is not matching");
            ...
            assertEquals(r1Renamed.getProperty("key2"), r2.getProperty("key2"), "Properties are not equal");
    ...
    public void getResourceoperation() throws Exception {
        ...
        r2.setDescription("this is test desc this is test desc this is test desc this is test desc this is test desc " + "this is test desc this is test desc this is test desc this is test descthis is test desc ");
