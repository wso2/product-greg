 ...
 */
public class QueryWSTestCase extends GREGIntegrationBaseTest {
    ...
    public void putRegistryQueries() throws RegistryException {
        ...
        try {
            ...
            resource1.addProperty(RegistryConstants.RESULT_TYPE_PROPERTY_NAME, RegistryConstants.RESOURCES_RESULT_TYPE);
