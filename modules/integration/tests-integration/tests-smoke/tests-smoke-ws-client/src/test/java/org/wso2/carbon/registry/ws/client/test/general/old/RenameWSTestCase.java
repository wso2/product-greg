 ...
 */
public class RenameWSTestCase extends GREGIntegrationBaseTest {
    ...
    public void rootLevelCollectionRename() throws Exception {
        ...
        assertTrue(failed, "Resource should not be " + "accessible from the old path after renaming the parent.");
