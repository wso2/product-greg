...
public class AtomFeedTestCase extends GREGIntegrationBaseTest{
    ...
    public void atomFeedTest() throws RegistryException, XPathExpressionException {
...
//        Checking whether description is correct
    ...
    private String constructAtomUrl(String path) throws XPathExpressionException {
        return UrlGenerationUtil.getRemoteRegistryURL(automationContext.getDefaultInstance()) + "atom" + path;
    }
