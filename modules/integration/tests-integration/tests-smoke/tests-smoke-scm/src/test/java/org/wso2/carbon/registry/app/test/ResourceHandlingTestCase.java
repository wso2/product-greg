 ...
 */
public class ResourceHandlingTestCase extends GREGIntegrationBaseTest{
    ...
    public void getResourceOperationTest() throws RegistryException {
        ...
        assertEquals(r3.getAuthorUserName(), userNameWithoutDomain, "Author names are not Equal");

        r3 = registry.get(path);

        assertEquals(r3.getAuthorUserName(), userNameWithoutDomain, "Author User names are not Equal");
        ...
        assertEquals(r3.getLastUpdaterUserName(), userNameWithoutDomain, "Last Updated names are not Equal");
