 ...
 */
public class RatingWSTestCase extends GREGIntegrationBaseTest {
    ...
    public void editResourceRating() throws Exception {
        ...
        assertEquals(rating_edit, (float) 3.0, (float) 0.01, "Rating of the resource /d61/d17/d18/r1 should be 3.");
    }
