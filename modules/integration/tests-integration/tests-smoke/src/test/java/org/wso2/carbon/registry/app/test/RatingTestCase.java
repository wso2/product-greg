 ...
 */
public class RatingTestCase extends GREGIntegrationBaseTest {
    ...
    public void AddResourceRatingTest() throws Exception {
        ...
        int ratingVal = registry.getRating("/d16/d17/r1", userNameWithoutDomain);
    ...
    public void AddCollectionRatingTest() throws Exception {
        ...
        int ratingVal = registry.getRating("/d16/d18", userNameWithoutDomain);
