 ...
 */
public class TestAssociationWSTestCase extends GREGIntegrationBaseTest {
    ...
    public boolean associationPathExists(String path, String assoPath) throws Exception {
