 ...
 */
public class VersionHandlingWSTestCase extends GREGIntegrationBaseTest {
    ...
    public void simpleCollectionVersioning() throws Exception {
        ...
        assertEquals(5, c1Versions.length);
    }
    ...
    public void rootLevelVersioning() throws Exception {
        ...
        assertTrue(RegistryUtils.containsAsSubString("/_vtr1", rootv0Children), "Root should have child vtr1");
        assertTrue(RegistryUtils.containsAsSubString("/_vtc2", rootv0Children), "Root should have child vtc2");
        Collection rootv1 = (Collection) registry.get(rootVersions[1]);
        String[] rootv1Children = (String[]) rootv1.getContent();
        assertTrue(RegistryUtils.containsAsSubString("/_vtr1", rootv1Children), "Root should have child vtr1");
        assertFalse(RegistryUtils.containsAsSubString("/_vtc2", rootv1Children), "Root should not have child vtc2");
    }
    ...
    public void testGetContentOfOldData() throws Exception {
        ...
        assertEquals(contentRetrieved, content, "Content does not match");
    ...
    public void cleanup() throws RegistryException {
        registry.delete("/_version");
        registry.delete("/_v2");
        registry.delete("/_v3");
        registry.delete("/_v4");
        registry.delete("/_abc2");
        registry.delete("/_test");
        registry.delete("/_vtc2");
        registry.delete("/_vtr1");
    }
}
