...
public class GregCustomRxtNotesTestESTestCase extends GregESTestBaseTest {
    private static final Log log = LogFactory.getLog(GregCustomRxtNotesTestESTestCase.class);
    ...
    public GregCustomRxtNotesTestESTestCase(TestUserMode userMode) {
