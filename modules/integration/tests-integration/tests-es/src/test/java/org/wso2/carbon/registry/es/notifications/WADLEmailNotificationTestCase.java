...
/**
 * This test class can be used to check the email notification functionality on WADL resources.
 */
public class WADLEmailNotificationTestCase extends GregESTestBaseTest {
    ...
    public WADLEmailNotificationTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.greg", "wso2.greg.es"}, description = "Adding subscription to a wadl LC check list item uncheck",
          dependsOnMethods = {"checkLCCheckItemsOnWADL"})
    ...
    @Test(groups = {"wso2.greg", "wso2.greg.es"}, description = "Adding subscription to a wadl LC state change",
          dependsOnMethods = {"uncheckLCCheckItemsOnWADL"})
    ...
    public void checkLCCheckItemsOnWADL() throws Exception {
        queryParamMap.put("type", "wadl");
    ...
    public void uncheckLCCheckItemsOnWADL() throws Exception {
        queryParamMap.put("type", "wadl");
        queryParamMap.put("lifecycle", lifeCycleName);
        JSONObject LCStateobj = getLifeCycleState(assetId, "wadl");
        JSONObject dataObj = LCStateobj.getJSONObject("data");
