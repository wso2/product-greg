...
public class GregRestResourceUsedByAssociationTestCase extends GregESTestBaseTest {
    ...
    public GregRestResourceUsedByAssociationTestCase(TestUserMode userMode) {
    ...
    public void createAssociationUsedBy() throws JSONException, IOException, ParseException, InterruptedException {

        JSONObject dataObject = new JSONObject();

        dataObject.put("associationType", "usedBy");
        ...
        ClientResponse associationList = genericRestClient.geneticRestRequestGet(publisherUrl +
                "/association/restservice/usedBy/" + spaceAssetId, queryParamMap, headerMap, cookieHeader);
