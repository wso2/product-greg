...
public class GregStoreSearchHistoryTestCase extends GregESTestBaseTest {
    protected Log log = LogFactory.getLog(GregStoreSearchHistoryTestCase.class);
    ...
    public GregStoreSearchHistoryTestCase(TestUserMode userMode) {
