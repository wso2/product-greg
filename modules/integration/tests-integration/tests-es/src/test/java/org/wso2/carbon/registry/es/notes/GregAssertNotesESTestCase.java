...
public class GregAssertNotesESTestCase extends GregESTestBaseTest {
    private static final Log log = LogFactory.getLog(GregAssertNotesESTestCase.class);
    ...
    public GregAssertNotesESTestCase(TestUserMode userMode) {
