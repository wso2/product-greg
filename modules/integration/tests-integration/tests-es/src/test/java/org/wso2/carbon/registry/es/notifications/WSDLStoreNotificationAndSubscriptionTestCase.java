...
/**
 * This class testes subscription & notification for wsdls on store notification
 */
public class WSDLStoreNotificationAndSubscriptionTestCase extends GregESTestBaseTest {

    private static final Log log = LogFactory.getLog(WSDLStoreNotificationAndSubscriptionTestCase.class);
    ...
    public WSDLStoreNotificationAndSubscriptionTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.greg",
          ...
          dependsOnMethods = {"changeLCStateWSDL"})
    public void addWrongSubscriptionMethod() throws JSONException, IOException {
        ...
        ClientResponse response = genericRestClient
                .geneticRestRequestPost(storeUrl + "/subscription/wsdl/" + assetId, MediaType.APPLICATION_JSON,
