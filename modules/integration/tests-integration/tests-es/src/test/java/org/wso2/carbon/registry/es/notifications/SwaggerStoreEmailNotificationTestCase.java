...
public class SwaggerStoreEmailNotificationTestCase extends GregESTestBaseTest {

    private static final Log log = LogFactory.getLog(SwaggerStoreEmailNotificationTestCase.class);
    ...
    public SwaggerStoreEmailNotificationTestCase(TestUserMode userMode) {
    ...
    public void init() throws Exception {
        ...
        axis2File = new File(
                ...
                + "axis2.xml");
        //need lifeCycleAdminServiceClient to attach a lifecycle to the swagger, as policies does not come with
