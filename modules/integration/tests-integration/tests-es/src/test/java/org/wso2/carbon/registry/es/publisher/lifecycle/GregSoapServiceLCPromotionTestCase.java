 ...
 */
public class GregSoapServiceLCPromotionTestCase extends GregESTestBaseTest {

    private static final Log log = LogFactory.getLog(GregSoapServiceLCPromotionTestCase.class);
    ...
    public GregSoapServiceLCPromotionTestCase(TestUserMode userMode) {
