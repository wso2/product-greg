...
public class ServiceTestClientCase extends GREGIntegrationBaseTest{
    ...
    public void initTest() throws Exception {
        ...
        configPath = FrameworkPathUtil.getSystemResourceLocation() + "artifacts" +
...
//
        ...
        PropertiesAdminServiceClient propertiesAdminServiceClient =
                new PropertiesAdminServiceClient(getBackendURL(), getSessionCookie());
        ...
        assertTrue(retentionBean.getUserName().contains(automationContext.getContextTenant().getContextUser().getUserName()));
    }
    ...
    private void restartServer() throws Exception {
        ServerConfigurationManager manager = new ServerConfigurationManager("GREG", TestUserMode.SUPER_TENANT_ADMIN);
        manager.restartGracefully();
    }
}
