...
public class LifeCycleServiceTestCase {
    ...
    private String wsdl_path = "/_system/governance/trunk/wsdls/com/foo/BizService.wsdl";
    private String service_path = "/_system/governance/trunk/services/com/foo/BizService";
    ...
    public void init() throws Exception {
        context = new AutomationContext("GREG", TestUserMode.SUPER_TENANT_ADMIN);
        registry =
                new RegistryProviderUtil().getWSRegistry(context);
        governance = new RegistryProviderUtil().getGovernanceRegistry(registry, context);
    }
    ...
    public void testCheckLifeCycle()
            throws RegistryException, InterruptedException, XPathExpressionException {
        String testStageState;


        if (!context.getContextTenant().getDomain().equalsIgnoreCase("CARBON.SUPPER")) {
