...
public class ServiceAndEndpointTestCase {
    ...
    public void initializeAPIObject() throws Exception {
        ...
        WSRegistryServiceClient wsRegistry = registryProviderUtil.getWSRegistry(context);
        Registry governance = registryProviderUtil.getGovernanceRegistry(wsRegistry, context);
