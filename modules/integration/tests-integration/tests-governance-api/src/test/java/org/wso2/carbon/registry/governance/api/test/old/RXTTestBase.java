...
public abstract class RXTTestBase {
    ...
    protected AutomationContext gregContext;

    @BeforeClass(groups = {"wso2.greg"})
    public void initTest() throws Exception {
        gregContext = new AutomationContext("GREG", TestUserMode.SUPER_TENANT_ADMIN);
        RegistryProviderUtil registryProviderUtil = new RegistryProviderUtil();
        WSRegistryServiceClient wsRegistry = registryProviderUtil.getWSRegistry(gregContext);
        registry = registryProviderUtil.getGovernanceRegistry(wsRegistry, gregContext);
