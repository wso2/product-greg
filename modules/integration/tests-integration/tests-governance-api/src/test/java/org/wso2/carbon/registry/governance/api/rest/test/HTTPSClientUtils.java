...
/**
 * This class is a high level implementation for the HTTP client for Secure connection
 */
public class HTTPSClientUtils {
     ...
     */
    public static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse doGet(String url,
     ...
     * @throws IOException if connection issue occurred
     */
    public static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse doPost(String url,
     ...
     * @throws IOException if connection issue occurred
     */
    public static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse doPut(String url,
            Map<String, String> headers, String payload) throws IOException {
        HttpClient httpClient = getHttpsClient();
     ...
     * @throws IOException
     */
    public static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse doPost(URL url, Map<String, String> headers,
     ...
     * @throws IOException if connection issue occurred
     */
    public static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse doPost(URL url, String urlParams,
            Map<String, String> headers) throws IOException {
     ...
     * @throws IOException if connection issue occurred
     */
    private static org.apache.http.HttpResponse sendPOSTMessage(HttpClient httpClient, String url,
            Map<String, String> headers, List<NameValuePair> urlParameters) throws IOException {
     ...
     * @throws IOException if connection issue occurred
     */
    private static org.apache.http.HttpResponse sendPUTMessage(HttpClient httpClient, String url,
            Map<String, String> headers, String body) throws IOException {
     ...
     */
    private static org.wso2.carbon.registry.governance.api.rest.test.HttpResponse constructResponse(
        ...
        org.wso2.carbon.registry.governance.api.rest.test.HttpResponse res = new org.wso2.carbon.registry.governance.api.rest.test.HttpResponse(
                body, code, heads);
        return res;
    }
