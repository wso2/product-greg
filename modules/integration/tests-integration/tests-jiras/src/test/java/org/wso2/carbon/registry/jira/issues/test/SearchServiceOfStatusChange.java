...
public class SearchServiceOfStatusChange extends GREGIntegrationBaseTest {
    ...
    public void init() throws Exception {
        ...
        searchAdminServiceClient =
                new SearchAdminServiceClient(backendURL, session);
    ...
    public String addService() throws RegistryException {
