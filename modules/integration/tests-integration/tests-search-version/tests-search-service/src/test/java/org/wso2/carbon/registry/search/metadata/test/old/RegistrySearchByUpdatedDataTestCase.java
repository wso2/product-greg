...
*/
public class RegistrySearchByUpdatedDataTestCase extends GREGIntegrationBaseTest {
    ...
    public void init() throws Exception {
        ...
        ServiceManager serviceManager =
                new ServiceManager(registryProviderUtil.getGovernanceRegistry(registry, automationContext));
        Service service =
