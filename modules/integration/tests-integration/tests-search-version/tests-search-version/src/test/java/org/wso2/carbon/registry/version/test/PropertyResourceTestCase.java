...
public class PropertyResourceTestCase extends GREGIntegrationBaseTest {
    ...
    private void addResource()
        ...
        assertTrue(resourceAdminClient.getResource(PATHROOT)[0].getAuthorUserName().contains(userNameWithoutDomain));
        ...
        assertTrue(resourceAdminClient.getResource(PATHLEAF)[0].getAuthorUserName().contains(userNameWithoutDomain));

        String path3 = FrameworkPathUtil.getSystemResourceLocation() + "artifacts" + File.separator
                       + "GREG" + File.separator + "testresource.txt";
    ...
    public void testVersionTagRoot()
        ...
        infoServiceAdminClient.addTag("testTag", PATHROOT, sessionCookie);
        TagBean tagBean = infoServiceAdminClient.getTags(PATHROOT, sessionCookie);
        boolean status = false;
    ...
    public void testVersionTagLeaf()
            throws ResourceAdminServiceExceptionException, RemoteException, RegistryException,
                   RegistryExceptionException {
        infoServiceAdminClient.addTag("testTag", PATHLEAF, sessionCookie);
        TagBean tagBean = infoServiceAdminClient.getTags(PATHLEAF, sessionCookie);
        boolean status = false;
        Tag[] tags1 = tagBean.getTags();
    ...
    public void testVersionCommentRoot()
        ...
        infoServiceAdminClient.addComment("This is a comment", PATHROOT, sessionCookie);
        CommentBean commentBean = infoServiceAdminClient.getComments(PATHROOT, sessionCookie);
    ...
    public void testVersionCommentLeaf()
        ...
        infoServiceAdminClient.addComment("This is a comment", PATHLEAF, sessionCookie);
        CommentBean commentBean = infoServiceAdminClient.getComments(PATHLEAF, sessionCookie);
        assertEquals("This is a comment", commentBean.getComments()[0].getContent());
        resourceAdminClient.createVersion(PATHLEAF);
        VersionPath[] vp1 = resourceAdminClient.getVersionPaths(PATHLEAF);
        String verPath = vp1[0].getCompleteVersionPath();
    ...
    public void testAddNewLifeCycle(String LCName, String fileName)
        ...
        String resourcePath = FrameworkPathUtil.getSystemResourceLocation() + "artifacts" + File.separator + "GREG" + File.separator + "lifecycle" + File.separator + fileName;
