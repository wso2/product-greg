...
public class CollectionTestCase extends GREGIntegrationBaseTest{
    ...
    public void initializeTests() throws Exception {
        ...
        COLLECTION_USERS = new String[]{userNameWithoutDomain};
        ...
        adminUserManagementClient = new UserManagementClient(backEndUrl,
                                                             sessionCookie);
    ...
    public void testResourceRestore()
        ...
        assertTrue(resourceAdminClient.getResource(PATH + "/testresource")[0].getAuthorUserName().contains(userNameWithoutDomain));


        resourceAdminClient.createVersion(PATH);
        VersionPath[] vp1 = resourceAdminClient.getVersionPaths(PATH);
        String verPath = vp1[0].getCompleteVersionPath();
        assertTrue(resourceAdminClient.getResource(verPath)[0].getAuthorUserName().contains(userNameWithoutDomain));
    ...
    public void testTagRestore()
        ...
        infoServiceAdminClient.addTag("testTag", PATH, sessionCookie);
        ...
        VersionPath[] vp1 = resourceAdminClient.getVersionPaths(PATH);
        String verPath = vp1[0].getCompleteVersionPath();
        TagBean tagBean2 = infoServiceAdminClient.getTags(verPath, sessionCookie);
        ...
        infoServiceAdminClient.removeTag("testTag", PATH, sessionCookie);
        TagBean tagBean3 = infoServiceAdminClient.getTags(PATH, sessionCookie);
        Tag[] tags3;
        ...
        assertTrue(status);
        resourceAdminClient.restoreVersion(verPath);
        TagBean tagBean4 = infoServiceAdminClient.getTags(PATH, sessionCookie);
    ...
    public void testColCommentRestore()
        ...
        assertEquals("This is a comment",
                     infoServiceAdminClient.getComments(verPath, sessionCookie).
                             getComments()[0].getContent());

        infoServiceAdminClient.removeComment(infoServiceAdminClient.getComments(PATH1, sessionCookie).
                getComments()[0].getCommentPath(), sessionCookie);

        assertNull(infoServiceAdminClient.getComments(PATH1, sessionCookie).getComments());
        resourceAdminClient.restoreVersion(verPath);
        assertEquals("This is a comment", infoServiceAdminClient.getComments(PATH1, sessionCookie).getComments()[0].getContent());
        assertNull(deleteVersion(PATH1));
    }
