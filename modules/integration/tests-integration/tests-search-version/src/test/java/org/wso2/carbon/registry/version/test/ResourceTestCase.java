...
public class ResourceTestCase extends GREGIntegrationBaseTest {
    ...
    private Netapi32Util.UserInfo userInfo;
    ...
    public void initializeTests() throws LoginAuthenticationExceptionException, IOException,
        ...
        assertTrue(resourceAdminClient.getResource(LEAF_PATH)[0].getAuthorUserName().contains(userNameWithoutDomain));
    ...
    public void testDeleteVerRoot()
        ...
        assertTrue(resourceAdminClient.getResource(PATH3)[0].getAuthorUserName().contains(userNameWithoutDomain));
    ...
    public void testAddResourceDiff()
        ...
        assertTrue(resourceAdminClient.getResource(CSS_PATH)[0].getAuthorUserName().contains(userNameWithoutDomain));
