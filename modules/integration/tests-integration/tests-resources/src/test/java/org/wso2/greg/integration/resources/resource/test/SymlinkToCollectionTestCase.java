...
public class SymlinkToCollectionTestCase extends GREGIntegrationBaseTest {
    ...
    public void initialize()
        ...
        propertiesAdminServiceClient = new PropertiesAdminServiceClient(getBackendURL(),
                                                                        getSessionCookie());
    ...
    public void testAddCommentToResource()
        ...
        cBean = infoServiceAdminClient.getComments(PATH + COLL_NAME, getSessionCookie());
    ...
    public void testDeleteComment() throws RegistryException, RegistryExceptionException,
        ...
        infoServiceAdminClient.removeComment(comments[0].getCommentPath(), getSessionCookie());

        cBean = infoServiceAdminClient.getComments(SYMLINK_LOC + SYMLINK_NAME, getSessionCookie());
        comments = cBean.getComments();
    ...
    public void testAddRating() throws RegistryException, RegistryExceptionException,
        ...
        userRating = infoServiceAdminClient.getRatings(PATH + COLL_NAME, getSessionCookie()).getUserRating();
    ...
    public void testAddTag() throws RegistryException, IOException, RegistryExceptionException, LoginAuthenticationExceptionException, XPathExpressionException, URISyntaxException, SAXException, XMLStreamException {
        ...
        String tag = infoServiceAdminClient.getTags(SYMLINK_LOC + SYMLINK_NAME, getSessionCookie()).getTags()[0].getTagName();
        assertTrue(TAG.equalsIgnoreCase(tag), "Symlink - Tags does not match");

        tag = infoServiceAdminClient.getTags(PATH + COLL_NAME, getSessionCookie()).getTags()[0].getTagName();
    ...
    public void testRemoveTag() throws RegistryException, RegistryExceptionException,
        ...
        infoServiceAdminClient.getTags(SYMLINK_LOC + SYMLINK_NAME, getSessionCookie()).getTags()[0].getTagName();

        infoServiceAdminClient.getTags(PATH + COLL_NAME, getSessionCookie()).getTags()[0].getTagName();
    ...
    public void testAddSubscription()
        ...
        SubscriptionBean sBean = infoServiceAdminClient.getSubscriptions(PATH + COLL_NAME, getSessionCookie());
    ...
    public void testRemoveSubscription()
        ...
        infoServiceAdminClient.unsubscribe(
                SYMLINK_LOC + SYMLINK_NAME, sBean.getSubscriptionInstances()[0].getId(), getSessionCookie());

        sBean = infoServiceAdminClient.getSubscriptions(SYMLINK_LOC + SYMLINK_NAME, getSessionCookie());
        assertNull(sBean.getSubscriptionInstances(), "Symlink - Error removing subscriptions");

        sBean = infoServiceAdminClient.getSubscriptions(PATH + COLL_NAME, getSessionCookie());
    ...
    public void cleanup()
        ...
        UserManagementClient adminUserManagementClient =   new UserManagementClient(getBackendURL(),
                getSessionCookie());
