...
public class CollectionManagementTestCase extends GREGIntegrationBaseTest {
    ...
    public void testAddCollection()
            throws ResourceAdminServiceExceptionException, RemoteException, InterruptedException, XPathExpressionException {
