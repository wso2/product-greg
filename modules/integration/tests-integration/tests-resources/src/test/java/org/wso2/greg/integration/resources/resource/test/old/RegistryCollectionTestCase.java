...
//                       PARENT_PATH+"/"+ESB_COLL_NAME + " resource found in original path after move");
    ...
    public void cleanup()
        ...
        assertNull(resourceAdminServiceClient.getResource
                (PARENT_PATH+"/"+MOVED_COLLECTIONS_COLL_NAME)[0],PARENT_PATH+"/"+
                MOVED_COLLECTIONS_COLL_NAME+" found even after deleting");
