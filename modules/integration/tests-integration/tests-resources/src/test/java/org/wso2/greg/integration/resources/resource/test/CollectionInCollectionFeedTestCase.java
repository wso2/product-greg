...
public class CollectionInCollectionFeedTestCase extends GREGIntegrationBaseTest {
    ...
    @Test(groups = "wso2.greg", dependsOnMethods = "testRenameCollection")
    ...
    private String constructAtomUrl(String feedPath) throws XPathExpressionException {
        ...
        String registryURL;
            ...
            registryURL = UrlGenerationUtil.getRemoteRegistryURL(automationContext
                    .getDefaultInstance());
