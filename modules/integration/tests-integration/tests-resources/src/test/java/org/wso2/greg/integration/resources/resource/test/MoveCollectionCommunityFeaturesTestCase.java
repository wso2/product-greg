...
public class MoveCollectionCommunityFeaturesTestCase extends GREGIntegrationBaseTest {
    ...
    private static final String COLL_MOVED_LOCATION = "/c3/c4/";
    ...
    public void testAddDependencyToCollection()
        ...
        String path =  FrameworkPathUtil.getSystemResourceLocation()
    ...
    public void testDependenciesAfterMoving()
        ...
        String dependencyType = "depends";
        DependenciesBean bean = relationServiceClient.getDependencies(COLL_MOVED_LOCATION + COLL_NAME);
        assertTrue(dependencyType.equalsIgnoreCase(bean.getAssociationBeans()[0].getAssociationType()),
        ...
        assertTrue((COLL_MOVED_LOCATION + COLL_NAME).equalsIgnoreCase(bean.getAssociationBeans()[0].getSourcePath()),
    ...
    public void testAssociationsAfterMoving()
        ...
        AssociationTreeBean aTreeBean =
                relationServiceClient.getAssociationTree(COLL_MOVED_LOCATION + COLL_NAME, "association");
    ...
    public void testCommentsAfterMoving() throws RegistryException, RegistryExceptionException {
        ...
        CommentBean cBean = infoServiceAdminClient.getComments(COLL_MOVED_LOCATION + COLL_NAME, sessionId);
        Comment[] comments = cBean.getComments();
        boolean found = false;
        for (Comment comment : comments) {
            if ("This is a comment".equalsIgnoreCase(comment.getContent())) {
    ...
    public void testLifecycleAfterMoving()
        ...
        //associate the life cycle with the collection
        wsRegistryServiceClient.associateAspect(COLL_MOVED_LOCATION + COLL_NAME, ASPECT_NAME);
    ...
    public void testRatingAfterMoving() throws RegistryException, RegistryExceptionException {
        ...
        int userRating = infoServiceAdminClient.getRatings(COLL_MOVED_LOCATION + COLL_NAME, sessionId).getUserRating();
    ...
    public void testSubscriptionsAfterCopying()
        ...
        SubscriptionBean sBean = infoServiceAdminClient.getSubscriptions(COLL_MOVED_LOCATION + COLL_NAME, sessionId);
    ...
    public void testTagsAfterCopying() throws RegistryException, RegistryExceptionException {
        ...
        String tag =
                infoServiceAdminClient.getTags(COLL_MOVED_LOCATION + COLL_NAME, sessionId).getTags()[0].getTagName();
    ...
    public void cleanUp() throws Exception {
        resourceAdminClient.deleteResource("/c3");
