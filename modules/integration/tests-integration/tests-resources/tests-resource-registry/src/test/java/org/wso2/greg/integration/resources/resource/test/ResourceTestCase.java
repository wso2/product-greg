...
public class ResourceTestCase extends GREGIntegrationBaseTest {
    ...
    public void initializeTests() throws Exception {
        ...
        relationAdminServiceClient = new RelationAdminServiceClient(getBackendURL(), getSessionCookie());
    }

    @Test(groups = "wso2.greg", description = "Add resource to greg")
    public void testAddResource() throws IOException, ResourceAdminServiceExceptionException, XPathExpressionException {
    ...
    public void testAddAssociation() throws RemoteException, MalformedURLException, ResourceAdminServiceExceptionException, AddAssociationRegistryExceptionException {
    ...
    public void testRemoveAssociation() throws RemoteException, MalformedURLException, ResourceAdminServiceExceptionException, AddAssociationRegistryExceptionException {
    ...
    public void testCleanResources() throws ResourceAdminServiceExceptionException, RemoteException {
