...
public class GenericArtifactTestCase extends GREGIntegrationBaseTest{
    ...
    public void initTest() throws RegistryException, AxisFault, XPathExpressionException {
    ...
    @Test(groups = {"wso2.greg"}, description = "add an artefact with multiple longer lines",dependsOnMethods = "testAddNewRxtFile")
