package org.wso2.greg.integration.governance.api.ui.test;
...
public class ConfigureServiceUITestCase extends GREGIntegrationBaseTest {
    ...
    public void initialize() throws Exception {
        ...
        WSRegistryServiceClient wsRegistry =
                new RegistryProviderUtil().getWSRegistry(automationContext.getProductGroup().getGroupName(),
                        automationContext.getDefaultInstance().getName(),
                        automationContext.getConfigurationNode("//superTenant/tenant/@key")
    ...
    public void testCreateService() throws Exception {
        ...
        Thread.sleep(5000);
        assertTrue(governanceServiceClient.getConfiguration("service").contains("<value>None</value><value>Technical Owner</value><value>Business Owner</value>"), "Service Configuration not saved");
    }
     ...
     * @throws java.io.IOException
     */
    @Test(groups = "wso2.greg", description = "repeating the same field inside a table", dependsOnMethods = "testCreateService")
    /*@SetEnvironment(executionEnvironments = {ExecutionEnvironment.integration_user,
                                             ExecutionEnvironment.integration_tenant})*/
    public void testElementRepeat() throws Exception {
        String servicePath =
                FrameworkPathUtil.getSystemResourceLocation() + "artifacts" +
                        File.separator + "GREG" + File.separator + "services" +
        ...
        assertTrue(success, "Service Configuration not saved");
    }
    ...
    /*  @SetEnvironment(executionEnvironments = {ExecutionEnvironment.integration_user,
    ExecutionEnvironment.integration_tenant})*/
    public void testSubHeaders() throws Exception {
        String servicePath =
                FrameworkPathUtil.getSystemResourceLocation() + "artifacts" +
                        File.separator + "GREG" + File.separator + "services" +
        ...
        String serviceContent = FileManager.readFile(servicePath);
        boolean success = governanceServiceClient.saveConfiguration(serviceContent, "/_system/governance/repository/components/org.wso2.carbon.governance/types/service.rxt");
        assertFalse(success, "Service Configuration with wrong config should not be saved");
    }
     ...
     * @throws java.io.IOException
     */
    @Test(groups = "wso2.greg", description = "repeting the same field inside a table"/*,dependsOnMethods = "testSubHeaders"*/, enabled = false)
    /*@SetEnvironment(executionEnvironments = {ExecutionEnvironment.integration_user,
                                             ExecutionEnvironment.integration_tenant})*/
    ...
    @Test(groups = "wso2.greg", description = "repeting the same field inside a table"/*, dependsOnMethods = "testSyntaxErrors"*/)
    //  @SetEnvironment(executionEnvironments = {ExecutionEnvironment.integration_user})
    public void testListServicesAfterRestart() throws Exception {
        ...
        assertEquals(servicesAfter - servicesBefore, 3, "Number of services have changed after restart");
