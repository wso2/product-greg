...
public class CustomLifeCycleDemoteForWSDLLCTestCase extends GREGIntegrationBaseTest {
    ...
    public void init () throws Exception {
        ...
        activityAdminServiceClient = new ActivityAdminServiceClient(backendURL,
                sessionCookie);
    ...
    public void promoteServiceToCreation ()
        ...
        ActivityBean activityObjTrunk = activityAdminServiceClient.getActivities(getSessionCookie(), userNameWithoutDomain, servicePathTrunk, LifeCycleUtils.formatDate(Calendar
                .getInstance().getTime())
        ...
        assertTrue(activity.contains(userNameWithoutDomain), "Activity not found. User name not found on last " +
                "activity. " + activity);
    ...
    public void promoteServiceToDevelopment ()
        ...
        Thread.sleep(1000 * 10);
        activityObjTrunk = activityAdminServiceClient.getActivities(sessionCookie, userNameWithoutDomain
