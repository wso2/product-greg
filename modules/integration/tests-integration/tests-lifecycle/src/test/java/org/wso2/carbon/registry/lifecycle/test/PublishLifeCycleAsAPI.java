...
public class PublishLifeCycleAsAPI extends GREGIntegrationBaseTest {
    ...
    public void testAPICreation () throws RegistryException {
        ...
        assertTrue(governance.resourceExists
                ("apimgt/applicationdata/provider/" + userNameWithoutDomain + "/serviceName/1.0.0/api"),
    ...
    public void deleteLifeCycle ()
        ...
        if (governance.resourceExists("/apimgt/applicationdata/provider/" + userNameWithoutDomain)) {
            registry.delete("/_system/governance/apimgt/applicationdata/provider/" + userNameWithoutDomain);
        }
        registry = null;
        governance = null;
