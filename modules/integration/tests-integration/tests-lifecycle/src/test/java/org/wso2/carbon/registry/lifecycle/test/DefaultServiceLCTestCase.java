...
public class DefaultServiceLCTestCase extends GREGIntegrationBaseTest{
    ...
    public void init() throws Exception {
        ...
        lifeCycleAdminServiceClient = new LifeCycleAdminServiceClient(backendURL, sessionCookies);
