 ...
 */
public class REGISTRY2181DebugLogForLifeCycleChanges  extends GREGIntegrationBaseTest {
     ...
     * @throws RegistryExceptionException
     */
    @Test(groups = "wso2.greg", description = "Test debug log file contents",
          dependsOnMethods = "testPromoteLC")
    public void testDebugLog() throws RemoteException,
                                       CustomLifecyclesChecklistAdminServiceExceptionException,
                                       LifeCycleManagementServiceExceptionException,
                                       RegistryExceptionException {

    	String carbonHome =  System.getProperty("carbon.home");  
    	String debuglogFile = carbonHome + File.separator+ "repository" +File.separator +"logs"+File.separator+"wso2carbon_lchistory.log";
        String logMessage = readFileContent(debuglogFile);
    	assertNotNull(logMessage);
    	String logkeyword = "org.wso2.carbon.governance.registry.extensions.aspects.utils.StatWriter";
    	if (logMessage.contains(logkeyword)) {
    		assertTrue(true);
    	}
    }
