...
public class MultiplePromoteDemoteLifeCycleTestCase extends GREGIntegrationBaseTest {
    ...
    private static final String SERVICE_NAME = "IntergalacticService16";
    ...
    public void testCreateService () throws XMLStreamException, IOException,
        ...
        String servicePath = getTestArtifactLocation() + "artifacts" + File.separator +
                "GREG" + File.separator + "services" + File.separator + "intergalacticService16.metadata.xml";
    ...
    public void testVerifyAuditAdmin () throws Exception {
        ...
        assertEquals(getAuditRecords(auditPath, 1, USER, false), userName1WithoutDomain, "User is not testuser1");
