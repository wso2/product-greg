...
public class PermissionTestConstants {
    ...
    public static final String NON_ADMIN_TEST_ROLE = "nonAdminTestRole";
    ...
    public static String NON_ADMIN_ROLE_USER_1 = "nonAdminRoleUser1";
    public static String NON_ADMIN_ROLE_USER_2 = "nonAdminRoleUser2";
