...
public class GetAllTestCase extends TestSetup {
    ...
    public void initGetAllTest() throws RegistryException {
        super.init();
        stub = ((WSRegistryServiceClient)registry).getStub();
    ...
    public void testGetAllForResource() throws Exception {
        ...
        resource = WSRegistryClientUtils.transformWSResourcetoResource(
                (WSRegistryServiceClient)registry, resourceData.getResource(), null);
    ...
    public void testGetAllForCollection() throws Exception {
        ...
        resource = WSRegistryClientUtils.transformWSCollectiontoCollection(
                (WSRegistryServiceClient) registry, (WSCollection) resourceData.getResource(),
                null);
