...
public class ResourceManagementTestCase {
    ...
    public void testMetadata() throws ResourceAdminServiceExceptionException, RemoteException {
        MetadataBean mBean = resourceAdminClient.getMetadata(PATH + RES_NAME);

        assertTrue(userInfo.getUserNameWithoutDomain().equalsIgnoreCase(mBean.getAuthor()), "Author not correct");
    ...
    public void testUpdateResource() throws IOException, ResourceAdminServiceExceptionException {
        ...
        Assert.assertTrue(resourceAdminClient.getResource(PATH + RES_NAME)[0].getAuthorUserName().
