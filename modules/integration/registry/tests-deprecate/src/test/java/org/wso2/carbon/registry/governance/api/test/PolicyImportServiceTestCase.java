...
public class PolicyImportServiceTestCase {
    ...
    private String bpsRepoLocation = "https://svn.wso2.org/repos/wso2/trunk/commons/qa/qa-artifacts/bps/samples/samples" +
            "/security-basic/SecurePartnerBPEL" ;

    private String securityRepoLocation="http://svn.wso2.org/repos/wso2/carbon/platform/branches/4.2.0/" +
            "platform-integration/platform-automated-test-suite/1.2.0/org.wso2.carbon.automation.test.repo/src/main/" +
            "resources/security" ;
    ...
    public void testAddEncrOnlyAnonymousPolicy() throws RegistryException {
        String policy_url = repoLocation+ "/policy/EncrOnlyAnonymous.xml";
    ...
    public void testAddPolicySecurePartnerService01() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService01.xml";
    ...
    public void testAddPolicySecurePartnerService02() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService02.xml";
    ...
    public void testAddPolicySecurePartnerService03() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService03.xml";
    ...
    public void testAddPolicySecurePartnerService04() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService04.xml";
    ...
    public void testAddPolicySecurePartnerService05() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService05.xml";
    ...
    public void testAddPolicySecurePartnerService06() throws RegistryException {
        String policy_url = bpsRepoLocation+ "/PolicySecurePartnerService06.xml";
    ...
    public void testAddPolicySecurePartnerService07() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService07.xml";
    ...
    public void testAddPolicySecurePartnerService08() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService08.xml";
    ...
    public void testAddPolicySecurePartnerService09() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService09.xml";
    ...
    public void testAddPolicySecurePartnerService10() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService10.xml";
    ...
    public void testAddPolicySecurePartnerService11() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService11.xml";
    ...
    public void testAddPolicySecurePartnerService12() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService12.xml";
    ...
    public void testAddPolicySecurePartnerService13() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService13.xml";
    ...
    public void testAddPolicySecurePartnerService14() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService14.xml";
    ...
    public void testAddPolicySecurePartnerService15() throws RegistryException {
        String policy_url = bpsRepoLocation + "/PolicySecurePartnerService15.xml";
    ...
    public void testAddSecConSignOnly() throws RegistryException {
        String policy_url = securityRepoLocation + "/policies/scenario9-policy.xml";
        String policy_path = "/_system/governance/trunk/policies/scenario9-policy.xml";
        String keyword1 = "SecConSignOnly";
        ...
        try {
            assertTrue(registry.resourceExists(policy_path), "scenario9-policy.xml:");          //Assert Policy exists
            propertyAssertion(policy_path);                                                    //Assert Property
            policyContentAssertion(keyword1, keyword2, policy_path);                           //Assert content of Policy
            registry.delete(policy_path);                                                        //Remove Policy
            assertFalse(registry.resourceExists(policy_path), "Policy exists at " + policy_path);   //Assert Resource was deleted successfully
    ...
    public void testAddSgnEncrAnonymous() throws RegistryException {
        String policy_url = repoLocation + "/policy/SgnEncrAnonymous.xml";
    ...
    public void testAddSigEncr() throws RegistryException {
        String policy_url = repoLocation + "/policy/SigEncr.xml";
    ...
    public void testAddSigOnly() throws RegistryException {
        String policy_url = securityRepoLocation + "/policies/scenario2-policy.xml";
        String policy_path = "/_system/governance/trunk/policies/scenario2-policy.xml";
    ...
    public void testAddSignOnlyAnonymous() throws RegistryException {
        String policy_url = securityRepoLocation + "/policies/scenario3-policy.xml";
        String policy_path = "/_system/governance/trunk/policies/scenario3-policy.xml";
        String keyword1 = "SgnOnlyAnonymous";
        String keyword2 = "WssX509V3Token10";
    ...
    public void testAddUTOverTransport() throws RegistryException {
        String policy_url = repoLocation + "/policy/UTPolicy.xml";
