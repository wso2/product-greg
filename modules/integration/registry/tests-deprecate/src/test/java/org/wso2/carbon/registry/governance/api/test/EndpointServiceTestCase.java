...
public class EndpointServiceTestCase {
    ...
    public void testAddWsdlWithEndpoints() throws Exception {
        String wsdl_url =  "https://svn.wso2.org/repos/wso2/carbon/platform/branches/4.2.0/platform-integration/" +
                "platform-automated-test-suite/1.2.0/org.wso2.carbon.automation.test.repo/src/main/resources/artifacts/" +
