 ...
 */
public class TestResourcesWSTestCase {
    ...
    private void addSpacesInCollName() throws Exception {
        ...
        assertEquals(c1_actual.getProperty("key1"), c1.getProperty("key1"),
                     "Resource properties are not equal");
        assertEquals(c1_actual.getProperty("key2"), c1.getProperty("key2"),
                     "Resource properties are not equal");
