...
<head>
    ...
    <title>WSO2 Stratos Governance</title>
...
<%
    if("true".equals(session.getAttribute("add-tenant-success"))) {
        session.removeAttribute("add-tenant-success");
        %>
...
<div id="login-content">
				...
				<div id="footer">
					<div class="powered">
						<span>Powered by</span><a target="_blank" href="http://wso2.org/projects/gov"><img src="../tenant-login/images/powered.gif"/></a>
					</div>
