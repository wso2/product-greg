...
asset.manager = function(ctx) {
    ...
    return {
        ...
        create: function(options) {
            ...
            var parentPath = "/_system/governance/trunk/xqueries/".concat(version);
            var mediaType = "application/xquery+xml";
        ...
        update: function(options) {
            var log = new Log();
            var updatedContent = options.xquerycontent;
            if(!updatedContent){
                log.info('undefined');
            }else{
                var name = options.overview_name;
                var version = options.overview_version;
                var resourcePath = "/_system/governance/trunk/xqueries/"+version+"/"+name;
                var userRegistry = getRegistry(ctx.session);
                ...
                log.info('xQuery successfully updated');
            }
        },
