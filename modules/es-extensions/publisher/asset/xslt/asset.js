...
asset.manager = function(ctx) {
    ...
    return {
        ...
        create: function(options) {
            ...
            var parentPath = "/_system/governance/trunk/xslts/".concat(version);
            var mediaType = "application/xslt+xml";
        ...
        update: function(options) {
            var log = new Log();
            var updatedContent = options.xsltcontent;
            if(!updatedContent){
                log.info('undefined');
            }else{
                var name = options.overview_name;
                var version = options.overview_version;
                var resourcePath = "/_system/governance/trunk/xslts/"+version+"/"+name;
                var userRegistry = getRegistry(ctx.session);
                ...
                log.info('xslt successfully updated');
            }
        },
